  ...
  return (
    <div className={styles.homeContainer}>
      ...
      <div className={styles.pageContent}>
        ...
        <p style={{ textAlign: "center"}}>There is so much misinformation about the existence and availability of down payment assistance. The truth is, if you’re making a home purchase, you may qualify for down payment assistance. There are Federal, State and Local sources that are designed specifically to assist you with your down payment needs. If you are one of those buyers who believes that down payment assistance (DPA) is a resource that is only available to buyers with low incomes, think again! Many of the federal programs have NO maximum income limits. Other Non-Federal programs also have NO maximum income limits, and it does not matter where your dream home is located, within the state. One widely used assistance program allows income limits of up to $81,000 per year. Please speak with your Realtor and Lender about down payment assistance. Receiving DPA really could help you make a desired home purchase a reality and allow you to hold on to your reserves that may come in handy after you have purchased your new home.
          </p>
      </div>
{/* 
      <div className={styles.pageContent}>
